;+
; :Description:
;    Computes the mean square mean deviation between two datasets.
;    
...
;     Written by FaM, 2014.
;-
function w_MSD, ref, data, VALID=valid
  ...
  case size(ref, /N_DIMENSIONS) of
    1: return, mean(diff*diff, /NAN)
    2: return,  mean(diff*diff, /NAN, DIMENSION=2)
