...
;+
;
;  w_TRMM_old is the basis class for TRMM datasets in NetCDF format.
...
;     Written by FaM, 2010.
;-
Function w_TRMM_old::Init, FILE = file, SUBSET_LL = subset_ll, SUBSET_IJ = SUBSET_ij, LL_DATUM = ll_datum
  ...
  ;*********
  self.cropped = ''
  if NOT self->w_TRMM_old::define_subset(SUBSET_LL = subset_ll, SUBSET_IJ = SUBSET_ij, LL_DATUM = ll_datum) THEN RETURN, 0
...
;      Written by FaM, 2010.
;-
function w_TRMM_old::get_Var, varid, time, nt, _Ref_Extra = extra                     
...
;     Written by FaM, 2010.
;-
function w_TRMM_old::get_prcp, time, nt, units = units, t0 = t0, t1 = t1
...
function w_TRMM_old::get_Prcp_TimeSerie, x, y, $
                              time, nt, $
                              t0 = t0, t1 = t1, $
                              src = src, $
                              units = units, $
...
;     Written by FaM, 2010.
;-
pro w_TRMM_old::QuickPlotPrcp, WID = wid
...
;    Output is 1 if the w_TRMM_old object is updated successfully, 0 if not.
;    
;    
; :Categories:
;         WAVE/OBJ_GIS   
...
;      Written by FaM, 2010.
;-
function w_TRMM_old::define_subset, SUBSET_LL = subset_ll, SUBSET_IJ = SUBSET_ij, LL_DATUM = ll_datum
...
;     Written by FaM, 2010.
;-      
function w_TRMM_old::get_TimeSerie,varid, x, y, $
                              time, nt, $
                              T0=t0, T1=t1, $
                              SRC=src, $
                              K=K, $
