...
;     Written by FaM, 2010.
;-
Function w_WPRold::Init, DIRECTORY=directory, _REF_EXTRA=extra  
...
;        
;-
pro w_WPRold::get_time, time, nt, t0, t1
...
;    
;    This function have been enhanced for `w_WPRold` to include additional diagnostic variables.
;
; :Categories:
;         WAVE/OBJ_GIS   
;         
...
;     Written by FaM, 2010.
;-
function w_WPRold::get_Var_Info, Varid, $ ; The netCDF variable ID, returned from a previous call to NCDF_VARDEF or NCDF_VARID, or the name of the variable. 
                              out_id = out_id, $
                              units = units, $
...
pro w_WPRold::get_Varlist, varnames, PRINTVARS=printvars
...
;      Written by FaM, 2011.
;-
function w_WPRold::get_Var, Varid, $ 
                            time,  $
                            nt,  $
                            T0=t0, $
                            T1=t1, $
...
pro w_WPRold::altitudinal_gradient, Varid, grad_VarName, $
    FORCE=force, $
...
;     Written by FaM, 2010.
;-      
function w_WPRold::get_TimeSerie,varid, x, y, $
                              time, nt, $
                              T0=t0, T1=t1, $
                              SRC=src, $
                              K=K, $
