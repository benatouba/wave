...
pro examples_WtimelinePlot
  ...
  WtimelinePlot, data, time
  
  ;Change time interval
  WtimelinePlot, data, time, HOURS = 12, TITLE = 'Changed the X axis'
  
  ; Add some options
  WtimelinePlot, data, time, 'My data', COMENT1='Random data', COLOR1= 'red',  $
  ...
  WtimelinePlot, data, time, 'My data', COMENT1='Random data', COLOR1= 'red', ZOOM=zoom, $
...
pro examples_WScatterPlot
  
  x = LOADDATA(17)
  n = N_ELEMENTS(x)
  y = x * 2. + 1.
    
  WScatterPlot, x, y, XTITLE='X title', YTITLE='Y title', TITLE= 'Test plot'
  
  seed = 1
  noise = RandomU(seed, n)*10. - 5.
  y = x + noise + 20.
  
  WScatterPlot, x, y, XTITLE='X title', YTITLE='Y title', TITLE= 'Test plot 2', /LEGEND_UL, COLOR='red', PSYM=6
end
